...
class MLP(nn.Module):
    def __init__(self, num_classes, count_of_features):
        ...
        self.fc0 = nn.Linear(count_of_features, 500)  # полносвязный слой
        self.fc1 = nn.Linear(500, 500)  # полносвязный слой
        self.fc2 = nn.Linear(500, num_classes)  # полносвязный слой
